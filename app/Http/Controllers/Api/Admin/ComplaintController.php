...
class ComplaintController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json(['status' => true, 'message' => 'Complaints retrieved', 'data' => $complaints]);
    }
    ...
    {
        $complaint = Complaint::with(['user', 'order', 'actions.admin'])->find($id);
        if (!$complaint) return response()->json(['status' => false, 'message' => 'Complaint not found'], 404);

        return response()->json(['status' => true, 'message' => 'Complaint details retrieved', 'data' => $complaint]);
    }
    ...
    public function takeAction(Request $request, $id)
    {
        ...
        return DB::transaction(function () use ($request, $complaint) {
            ...
            return response()->json([
                ...
                'data' => $complaint->load('actions.admin')
            ]);
        });
    }
