...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const sparklineData = {
        ...
        'sparkline-active': { color: '#6366F1', data: [30, 20, 40, 25, 45, 35, 50] },
        'sparkline-orders': { color: '#3B82F6', data: [20, 40, 30, 50, 25, 45, 35] },
        'sparkline-rating': { color: '#F59E0B', data: [40, 30, 50, 35, 20, 45, 30] }
    };
