                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white dark:bg-[#1A1A31] p-6 rounded-[2rem] border border-slate-100 dark:border-white/5 shadow-sm">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="w-8 h-8 rounded-xl bg-indigo-500/10 text-indigo-600 flex items-center justify-center font-black text-[10px]"><img src="{{ asset('assets/images/Vector (1).svg') }}" alt="SAR" class="inline-block w-4 h-4 align-middle"></div>
                        </div>
                    ...
                    <table class="w-full text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}">
                        ...
                        <tbody class="text-xs font-bold">
                            ...
                            <tr class="border-b border-slate-50 dark:border-white/5 last:border-0 hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all"
                                ...
                                <td class="py-5 px-2 text-slate-600 dark:text-slate-300 font-black">{{ optional($invoice->order->service)->{'name_'.app()->getLocale()} ?? '-' }}</td>
                                <td class="py-5 px-2 text-slate-400">{{ optional(optional($invoice->order->service)->category)->{'name_'.app()->getLocale()} ?? '-' }}</td>
                                <td class="py-5 px-2 text-slate-400 truncate max-w-[150px]">{{ $invoice->order->address ?? '-' }}</td>
                                <td class="py-5 px-2">
                                    <div class="flex items-center gap-2">
                                        <div class="w-6 h-6 rounded-lg bg-primary/10 flex items-center justify-center text-[10px] text-primary font-black">
                                            {{ mb_substr(optional(optional($invoice->order->technician)->user)->name ?? '-', 0, 1) }}
                                        </div>
                                        <span class="text-slate-800 dark:text-white">{{ optional(optional($invoice->order->technician)->user)->name ?? '-' }}</span>
                                    </div>
                                </td>
                                <td class="py-5 px-2">
                    ...
                    <table class="w-full text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}">
                        ...
                        <tbody class="text-xs font-bold">
                            ...
                            <tr class="border-b border-slate-50 dark:border-white/5 last:border-0 hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all"
                                ...
                                <td class="py-5 px-2 text-slate-600 dark:text-slate-300 font-black">{{ optional($payment->order->service)->{'name_'.app()->getLocale()} ?? '-' }}</td>
                                <td class="py-5 px-2 text-slate-400">{{ optional(optional($payment->order->service)->category)->{'name_'.app()->getLocale()} ?? '-' }}</td>
                    ...
                    <table class="w-full text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}">
                        ...
                        <tbody class="text-xs font-bold">
                            ...
                            <tr class="border-b border-slate-50 dark:border-white/5 last:border-0 hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all"
                                ...
                                <td class="py-5 px-2 text-slate-800 dark:text-white font-black">{{ number_format($contract->project_value, 2) }} <img src="{{ asset('assets/images/Vector (1).svg') }}" alt="SAR" class="inline-block w-4 h-4 align-middle"></td>
                                <td class="py-5 px-2 text-slate-800 dark:text-white font-black">{{ number_format($contract->paid_amount, 2) }} <img src="{{ asset('assets/images/Vector (1).svg') }}" alt="SAR" class="inline-block w-4 h-4 align-middle"></td>
                                <td class="py-5 px-2 text-slate-800 dark:text-white font-black">{{ number_format($contract->remaining_amount, 2) }} <img src="{{ asset('assets/images/Vector (1).svg') }}" alt="SAR" class="inline-block w-4 h-4 align-middle"></td>
