...
@section('title', __('Blocked Customers'))
                    ...
                    <tr>
                        <td colspan="8" class="py-24 text-center">
                             <div class="flex flex-col items-center max-w-sm mx-auto">
                                <div class="w-24 h-24 bg-slate-50 dark:bg-white/5 rounded-[2.5rem] flex items-center justify-center mb-6 text-slate-200 dark:text-slate-700 transform rotate-12">
                                    <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                                    </svg>
                                </div>
                                <h3 class="font-black text-xl text-slate-800 dark:text-white mb-2">{{ __('No blocked customers found') }}</h3>
                                <p class="text-slate-400 font-bold text-sm">{{ __('When a customer is blocked, they will appear in this list.') }}</p>
                             </div>
                        </td>
                    </tr>
                    @endforelse
