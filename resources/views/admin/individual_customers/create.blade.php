...
@section('page_title', __('Add New Individual Customer'))
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-black text-slate-800 dark:text-white">{{ __('Add New Individual Customer') }}</h1>
        </div>
    </div>

    <!-- Main Card -->
    <div class="bg-white dark:bg-[#1A1A31] rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-white/5 overflow-hidden">
        <form action="{{ route('admin.individual-customers.store') }}" method="POST" class="p-8 md:p-12">
            @csrf
