...
@section('title', __('Policy Details') . ' - ' . __('MatraqaTec'))
...
<div class="space-y-8 animate-in fade-in slide-in-from-bottom duration-700">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-black text-slate-800 dark:text-white">{{ __('Privacy Policy') }}</h1>
        </div>
        
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.privacy-policies.edit', $item->id) }}" class="px-6 py-3 bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 rounded-xl text-sm font-black hover:bg-slate-200 transition-all flex items-center gap-2">
