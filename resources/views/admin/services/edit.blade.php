            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative w-full h-48 rounded-xl bg-slate-50 dark:bg-white/5 border-2 border-dashed border-slate-200 dark:border-white/10 flex flex-col items-center justify-center text-center cursor-pointer hover:border-primary transition-colors group overflow-hidden">
                        ...
                        <img id="mainImagePreview" src="{{ $item->image ? Storage::url($item->image) : '' }}" class="absolute inset-0 w-full h-full object-cover {{ $item->image ? '' : 'opacity-0' }} transition-opacity z-0">
                ...
                <div>
                    ...
                    <div class="relative w-full h-48 rounded-xl bg-slate-50 dark:bg-white/5 border-2 border-dashed border-slate-200 dark:border-white/10 flex flex-col items-center justify-center text-center cursor-pointer hover:border-primary transition-colors group overflow-hidden">
                        ...
                        <img id="iconPreview" src="{{ $item->icon ? Storage::url($item->icon) : '' }}" class="absolute inset-0 w-full h-full object-contain p-4 {{ $item->icon ? '' : 'opacity-0' }} transition-opacity z-0">
