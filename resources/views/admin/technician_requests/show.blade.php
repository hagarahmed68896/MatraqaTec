...
<div class="space-y-6 pb-20">
    ...
    <div class="flex items-center gap-4 mb-2">
        <a href="{{ route('admin.technician-requests.index') }}" 
           class="w-10 h-10 rounded-xl bg-white dark:bg-[#1A1A31] border border-slate-100 dark:border-white/5 flex items-center justify-center text-slate-400 hover:text-primary dark:hover:text-white transition-all shadow-sm">
        ...
        <div class="px-10 pb-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-8 gap-x-12">
                ...
                <div class="flex items-center gap-4 group">
                    <div class="w-12 h-12 rounded-2xl bg-slate-50 dark:bg-white/5 flex items-center justify-center text-slate-400 group-hover:text-primary dark:hover:text-white transition-all">
