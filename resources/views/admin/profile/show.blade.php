                ...
                <div class="space-y-6 max-w-2xl">
                    ...
                    <div class="space-y-3" x-data="{ show: false }">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="show = !show" class="absolute {{ app()->getLocale() == 'ar' ? 'left-6' : 'right-6' }} top-1/2 -translate-y-1/2 text-slate-400 hover:text-primary transition-all">
